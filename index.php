...
<section class="main-slider style1">
    <div class="slider-box">
        ...
        <div class="banner-carousel owl-theme owl-carousel">
            <!-- Slide -->
            <div class="slide">
                <div class="image-layer" style="background-image:url(assets/images/slides/slider-1.jpg)">
                </div>
                <div class="slider-image"><img class="float-bob-y" src="assets/images/slides/slide-v1-1-image1.png"
                        alt=""></div>
                <div class="round-box">
                    <p>Refresh.</p>
                    <p>Rejuvenate.</p>
                ...
                <div class="auto-container">
                    <div class="content">
                        <div class="top-text">PREMIUM PACKAGED DRINKING WATER</div>
                        <div class="big-title">
                            <h2>Pure Water.<br> <span>Pure Life.</span></h2>
                        </div>
                        <div class="text">
                            <p>Refreshingly pure, expertly purified, and crafted to keep every moment fresh, healthy,
                                and revitalized.</p>
                        </div>
                        <div class="btns-box">
...
<section class="about-style3-area">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="fact-counter">
                        <div class="fact-counter-bg"
                            style="background-image: url(assets/images/parallax-background/fact-counter_box-bg.jpg);">
                        </div>
                        ...
                        <ul class="clearfix">
                            ...
                            <li class="single-fact-counter-style2 wow" data-wow-delay="200ms"
                                ...
                                <div class="icon">
                                    <div class="icon-bg"
                                        style="background-image: url(assets/images/shape/fact-counter-icon-bg.png);">
                                    </div>
                                ...
                                <div class="outer-box">
                                    <div class="title">
                                        <h6>100% Pure Water</h6>
                                        <p>Advanced purification ensures every bottle is fresh, safe, and refreshing.
                                        </p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="single-fact-counter-style2 wow" data-wow-delay="300ms"
                                ...
                                <div class="outer-box">
                                    <div class="title">
                                        ...
                                        <p>Every bottle undergoes strict quality checks to maintain premium standards.
                                        </p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="single-fact-counter-style2 wow" data-wow-delay="400ms"
                                ...
                                <div class="outer-box">
                                    <div class="title">
                                        <h6>Hygienic Bottling</h6>
                                        <p>Sealed in a clean and controlled environment for uncompromised freshness.</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="single-fact-counter-style2 wow" data-wow-delay="500ms"
                                ...
                                <div class="outer-box">
                                    <div class="title">
                                        <h6>Fast Delivery</h6>
                                        <p>Reliable doorstep delivery for homes, offices, events, and businesses.</p>
                                    </div>
                                </div>
                            </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="about-style3-content p-0 ">
                    <div class="row">
                        <div class="col-xl-6">

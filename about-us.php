                ...
                <div class="fact-counter">
                    ...
                    <ul class="clearfix">
                        ...
                        <li class="single-fact-counter-style2 wow" data-wow-delay="100ms"
                            ...
                            <div class="icon">
                                <div class="icon-bg"
                                    style="background-image: url(assets/images/shape/fact-counter-icon-bg.png);"></div>
                                <div class="icon-bg-overlay"
                                    style="background-image: url(assets/images/shape/fact-counter-icon-bg-overlay.png);"></div>
